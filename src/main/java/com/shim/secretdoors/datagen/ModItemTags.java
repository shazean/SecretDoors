...
public class ModItemTags extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        tag(ItemTags.DOORS)
                ...
                .add(SecretDoorsRegistry.SECRET_CHERRY_PLANK_DOOR_ITEM.get())
                .add(SecretDoorsRegistry.SECRET_BAMBOO_PLANK_DOOR_ITEM.get())
                ...
                .add(SecretDoorsRegistry.SECRET_CHERRY_LOG_DOOR_ITEM.get())
                .add(SecretDoorsRegistry.SECRET_BAMBOO_BLOCK_DOOR_ITEM.get())
                ...
                .add(SecretDoorsRegistry.SECRET_STRIPPED_CHERRY_LOG_DOOR_ITEM.get())
                .add(SecretDoorsRegistry.SECRET_STRIPPED_BAMBOO_BLOCK_DOOR_ITEM.get())
                ...
                .add(SecretDoorsRegistry.SECRET_STRIPPED_HORIZONTAL_BAMBOO_BLOCK_DOOR_ITEM.get())
                ...
                .add(SecretDoorsRegistry.SECRET_HORIZONTAL_CHERRY_LOG_DOOR_ITEM.get())
                .add(SecretDoorsRegistry.SECRET_HORIZONTAL_BAMBOO_BLOCK_DOOR_ITEM.get())
                ...
                .add(SecretDoorsRegistry.SECRET_CHISELED_BOOKSHELF_DOOR_ITEM.get())
        ...
        tag(ItemTags.TRAPDOORS)
                ...
                .add(SecretDoorsRegistry.SECRET_CHERRY_PLANK_TRAPDOOR_ITEM.get())
                .add(SecretDoorsRegistry.SECRET_BAMBOO_PLANK_TRAPDOOR_ITEM.get())
                ...
                .add(SecretDoorsRegistry.SECRET_CHERRY_LOG_TRAPDOOR_ITEM.get())
                .add(SecretDoorsRegistry.SECRET_BAMBOO_BLOCK_TRAPDOOR_ITEM.get())
                ...
                .add(SecretDoorsRegistry.SECRET_STRIPPED_CHERRY_LOG_TRAPDOOR_ITEM.get())
                .add(SecretDoorsRegistry.SECRET_STRIPPED_BAMBOO_BLOCK_TRAPDOOR_ITEM.get())
