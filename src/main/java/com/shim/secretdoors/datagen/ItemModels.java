...
public class ItemModels extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        generatedModel(SDBlocks.SECRET_CHERRY_PLANK_DOOR.get());
        generatedModel(SDBlocks.SECRET_BAMBOO_PLANK_DOOR.get());
        ...
        generatedModel(SDBlocks.SECRET_CHERRY_LOG_DOOR.get());
        generatedModel(SDBlocks.SECRET_BAMBOO_BLOCK_DOOR.get());
        ...
        generatedModel(SDBlocks.SECRET_STRIPPED_CHERRY_LOG_DOOR.get());
        generatedModel(SDBlocks.SECRET_STRIPPED_BAMBOO_BLOCK_DOOR.get());
        ...
        generatedModel(SDBlocks.SECRET_STRIPPED_HORIZONTAL_CHERRY_LOG_DOOR.get());
        generatedModel(SDBlocks.SECRET_STRIPPED_HORIZONTAL_BAMBOO_BLOCK_DOOR.get());
        ...
        generatedModel(SDBlocks.SECRET_HORIZONTAL_CHERRY_LOG_DOOR.get());
        generatedModel(SDBlocks.SECRET_HORIZONTAL_BAMBOO_BLOCK_DOOR.get());
        ...
        generatedModel(SDBlocks.SECRET_CHISELED_BOOKSHELF_DOOR.get());
    ...
    public void generatedModel(Block item) {
        singleTexture(SecretDoors.key(item), new ResourceLocation("item/generated"), "layer0", modLoc("item/" + SecretDoors.key(item)));
    }
