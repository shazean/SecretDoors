...
public class ModBlockTags extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        tag(BlockTags.DOORS)
                ...
                .add(SecretDoorsRegistry.SECRET_MANGROVE_PLANK_DOOR.get())
                .add(SecretDoorsRegistry.SECRET_CHERRY_PLANK_DOOR.get())
                .add(SecretDoorsRegistry.SECRET_BAMBOO_PLANK_DOOR.get())
                .add(SecretDoorsRegistry.SECRET_CRIMSON_PLANK_DOOR.get())
                .add(SecretDoorsRegistry.SECRET_WARPED_PLANK_DOOR.get())
                ...
                .add(SecretDoorsRegistry.SECRET_MANGROVE_LOG_DOOR.get())
                .add(SecretDoorsRegistry.SECRET_CHERRY_LOG_DOOR.get())
                .add(SecretDoorsRegistry.SECRET_BAMBOO_BLOCK_DOOR.get())
                .add(SecretDoorsRegistry.SECRET_CRIMSON_STEM_DOOR.get())
                .add(SecretDoorsRegistry.SECRET_WARPED_STEM_DOOR.get())
                ...
                .add(SecretDoorsRegistry.SECRET_STRIPPED_MANGROVE_LOG_DOOR.get())
                .add(SecretDoorsRegistry.SECRET_STRIPPED_CHERRY_LOG_DOOR.get())
                .add(SecretDoorsRegistry.SECRET_STRIPPED_BAMBOO_BLOCK_DOOR.get())
                .add(SecretDoorsRegistry.SECRET_STRIPPED_CRIMSON_STEM_DOOR.get())
                .add(SecretDoorsRegistry.SECRET_STRIPPED_WARPED_STEM_DOOR.get())
                ...
                .add(SecretDoorsRegistry.SECRET_STRIPPED_HORIZONTAL_MANGROVE_LOG_DOOR.get())
                .add(SecretDoorsRegistry.SECRET_STRIPPED_HORIZONTAL_CHERRY_LOG_DOOR.get())
                .add(SecretDoorsRegistry.SECRET_STRIPPED_HORIZONTAL_BAMBOO_BLOCK_DOOR.get())
                .add(SecretDoorsRegistry.SECRET_STRIPPED_HORIZONTAL_CRIMSON_STEM_DOOR.get())
                .add(SecretDoorsRegistry.SECRET_STRIPPED_HORIZONTAL_WARPED_STEM_DOOR.get())
                ...
                .add(SecretDoorsRegistry.SECRET_HORIZONTAL_MANGROVE_LOG_DOOR.get())
                .add(SecretDoorsRegistry.SECRET_HORIZONTAL_CHERRY_LOG_DOOR.get())
                .add(SecretDoorsRegistry.SECRET_HORIZONTAL_BAMBOO_BLOCK_DOOR.get())
                .add(SecretDoorsRegistry.SECRET_HORIZONTAL_CRIMSON_STEM_DOOR.get())
                .add(SecretDoorsRegistry.SECRET_HORIZONTAL_WARPED_STEM_DOOR.get())
                ...
                .add(SecretDoorsRegistry.SECRET_CHISELED_BOOKSHELF_DOOR.get())
        ...
        tag(BlockTags.TRAPDOORS)
                ...
                .add(SecretDoorsRegistry.SECRET_MANGROVE_PLANK_TRAPDOOR.get())
                .add(SecretDoorsRegistry.SECRET_CHERRY_PLANK_TRAPDOOR.get())
                .add(SecretDoorsRegistry.SECRET_BAMBOO_PLANK_TRAPDOOR.get())
                .add(SecretDoorsRegistry.SECRET_CRIMSON_PLANK_TRAPDOOR.get())
                .add(SecretDoorsRegistry.SECRET_WARPED_PLANK_TRAPDOOR.get())
                ...
                .add(SecretDoorsRegistry.SECRET_MANGROVE_LOG_TRAPDOOR.get())
                .add(SecretDoorsRegistry.SECRET_CHERRY_LOG_TRAPDOOR.get())
                .add(SecretDoorsRegistry.SECRET_BAMBOO_BLOCK_TRAPDOOR.get())
                .add(SecretDoorsRegistry.SECRET_CRIMSON_STEM_TRAPDOOR.get())
                .add(SecretDoorsRegistry.SECRET_WARPED_STEM_TRAPDOOR.get())
                ...
                .add(SecretDoorsRegistry.SECRET_STRIPPED_MANGROVE_LOG_TRAPDOOR.get())
                .add(SecretDoorsRegistry.SECRET_STRIPPED_CHERRY_LOG_TRAPDOOR.get())
                .add(SecretDoorsRegistry.SECRET_STRIPPED_BAMBOO_BLOCK_TRAPDOOR.get())
                .add(SecretDoorsRegistry.SECRET_STRIPPED_CRIMSON_STEM_TRAPDOOR.get())
                .add(SecretDoorsRegistry.SECRET_STRIPPED_WARPED_STEM_TRAPDOOR.get())
