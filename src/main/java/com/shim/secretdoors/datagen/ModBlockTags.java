...
public class ModBlockTags extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        tag(SDTags.Blocks.SECRET_WOODEN_PLANK_DOORS)
                ...
                .add(SDBlocks.SECRET_MANGROVE_PLANK_DOOR.get());
        ...
        tag(SDTags.Blocks.SECRET_LOG_DOORS)
                ...
                .add(SDBlocks.SECRET_MANGROVE_LOG_DOOR.get())
                ...
                .add(SDBlocks.SECRET_STRIPPED_MANGROVE_LOG_DOOR.get())
                ...
                .add(SDBlocks.SECRET_STRIPPED_HORIZONTAL_MANGROVE_LOG_DOOR.get())
                ...
                .add(SDBlocks.SECRET_HORIZONTAL_MANGROVE_LOG_DOOR.get());
        ...
        tag(SDTags.Blocks.SECRET_WOODEN_PLANK_TRAPDOORS)
                ...
                .add(SDBlocks.SECRET_MANGROVE_PLANK_TRAPDOOR.get());
        ...
        tag(SDTags.Blocks.SECRET_LOG_TRAPDOORS)
                ...
                .add(SDBlocks.SECRET_MANGROVE_LOG_TRAPDOOR.get())
                ...
                .add(SDBlocks.SECRET_STRIPPED_MANGROVE_LOG_TRAPDOOR.get());
