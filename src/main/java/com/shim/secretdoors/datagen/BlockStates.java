...
public class BlockStates extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        horizontalDoorBlock(SDBlocks.SECRET_STRIPPED_HORIZONTAL_OAK_LOG_DOOR.get(), "oak_log");
        horizontalDoorBlock(SDBlocks.SECRET_STRIPPED_HORIZONTAL_DARK_OAK_LOG_DOOR.get(), "dark_oak_log");
        horizontalDoorBlock(SDBlocks.SECRET_STRIPPED_HORIZONTAL_BIRCH_LOG_DOOR.get(), "birch_log");
        horizontalDoorBlock(SDBlocks.SECRET_STRIPPED_HORIZONTAL_ACACIA_LOG_DOOR.get(), "acacia_log");
        horizontalDoorBlock(SDBlocks.SECRET_STRIPPED_HORIZONTAL_SPRUCE_LOG_DOOR.get(), "spruce_log");
        horizontalDoorBlock(SDBlocks.SECRET_STRIPPED_HORIZONTAL_JUNGLE_LOG_DOOR.get(), "jungle_log");
        horizontalDoorBlock(SDBlocks.SECRET_STRIPPED_HORIZONTAL_MANGROVE_LOG_DOOR.get(), "mangrove_log");
        horizontalDoorBlock(SDBlocks.SECRET_STRIPPED_HORIZONTAL_CRIMSON_STEM_DOOR.get(), "crimson_stem");
        horizontalDoorBlock(SDBlocks.SECRET_STRIPPED_HORIZONTAL_WARPED_STEM_DOOR.get(), "warped_stem");
