...
public class BlockStates extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        doorBlock(SecretDoorsRegistry.SECRET_CHERRY_PLANK_DOOR.get(), mcLoc("block/cherry_planks"), mcLoc("block/cherry_planks"));
        doorBlock(SecretDoorsRegistry.SECRET_BAMBOO_PLANK_DOOR.get(), mcLoc("block/bamboo_planks"), mcLoc("block/bamboo_planks"));
        ...
        doorBlock(SecretDoorsRegistry.SECRET_CHERRY_LOG_DOOR.get(), mcLoc("block/cherry_log"), mcLoc("block/cherry_log"));
        doorBlock(SecretDoorsRegistry.SECRET_BAMBOO_BLOCK_DOOR.get(), mcLoc("block/bamboo_block"), mcLoc("block/bamboo_block"));
        ...
        doorBlock(SecretDoorsRegistry.SECRET_STRIPPED_CHERRY_LOG_DOOR.get(), mcLoc("block/stripped_cherry_log"), mcLoc("block/stripped_cherry_log"));
        doorBlock(SecretDoorsRegistry.SECRET_STRIPPED_BAMBOO_BLOCK_DOOR.get(), mcLoc("block/stripped_bamboo_block"), mcLoc("block/stripped_bamboo_block"));
        ...
        doorBlock(SecretDoorsRegistry.SECRET_STRIPPED_HORIZONTAL_CHERRY_LOG_DOOR.get(), modLoc("block/stripped_horizontal_cherry_log"), modLoc("block/stripped_horizontal_cherry_log"));
        doorBlock(SecretDoorsRegistry.SECRET_STRIPPED_HORIZONTAL_BAMBOO_BLOCK_DOOR.get(), modLoc("block/stripped_horizontal_bamboo_block"), modLoc("block/stripped_horizontal_bamboo_block"));
        ...
        doorBlock(SecretDoorsRegistry.SECRET_HORIZONTAL_CHERRY_LOG_DOOR.get(), modLoc("block/horizontal_cherry_log"), modLoc("block/horizontal_cherry_log"));
        doorBlock(SecretDoorsRegistry.SECRET_HORIZONTAL_BAMBOO_BLOCK_DOOR.get(), modLoc("block/horizontal_bamboo_block"), modLoc("block/horizontal_bamboo_block"));
        ...
        doorBlock(SecretDoorsRegistry.SECRET_CHISELED_BOOKSHELF_DOOR.get(), mcLoc("block/chiseled_bookshelf_occupied"), mcLoc("block/chiseled_bookshelf_occupied"));
        ...
        trapdoorBlock(SecretDoorsRegistry.SECRET_CHERRY_PLANK_TRAPDOOR.get(), mcLoc("block/cherry_planks"), true);
        trapdoorBlock(SecretDoorsRegistry.SECRET_BAMBOO_PLANK_TRAPDOOR.get(), mcLoc("block/bamboo_planks"), true);
        ...
        trapdoorBlock(SecretDoorsRegistry.SECRET_CHERRY_LOG_TRAPDOOR.get(), mcLoc("block/cherry_log"), true);
        trapdoorBlock(SecretDoorsRegistry.SECRET_BAMBOO_BLOCK_TRAPDOOR.get(), mcLoc("block/bamboo_block"), true);
        ...
        trapdoorBlock(SecretDoorsRegistry.SECRET_STRIPPED_CHERRY_LOG_TRAPDOOR.get(), mcLoc("block/stripped_cherry_log"), true);
        trapdoorBlock(SecretDoorsRegistry.SECRET_STRIPPED_BAMBOO_BLOCK_TRAPDOOR.get(), mcLoc("block/stripped_bamboo_block"), true);
        ...
        trapdoorBlock(SecretDoorsRegistry.SECRET_CHISELED_BOOKSHELF_TRAPDOOR.get(), mcLoc("block/chiseled_bookshelf_occupied"), true);
